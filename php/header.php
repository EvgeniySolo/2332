    ...
    <div class="container_fluid">
        <div class="row justify-content-center ">
            <div class="col-xl-10 header_intro_row" style="display: flex; justify-content: space-between;">
                <div class="logo"><a href="#"><img src="assets/img/logo3.png" alt=""></a></div>
                <div class="logoMobile"><a href="#"><img src="assets/img/logoMobile.png" alt=""></a></div>
                ...
                <div class="header_users">
                    ...
                    if (!empty($_SESSION['user']['login'])) {
                        echo '<i class="fa-regular fa-user" style="color: #ffffff;"></i>' . $_SESSION["user"]['login'];
                        
                        echo '<br><a href="php/logout.php" id="exit" style="color: red !important; font-size:13px; margin-left: 5px">Выход</a>';
